      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="grid grid-cols-2 md:col-span-2 gap-8">
            <div>
              <h3 className="text-purple-200 text-xs font-bold tracking-[0.2em] mb-6 uppercase">
                Explore
              </h3>
            ...
            {TEAM_MEMBERS.map((member, index) => (
              <div key={index} className="relative group cursor-pointer">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 px-3 py-1 bg-purple-200 text-gray-950 text-[10px] font-bold rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap shadow-xl">
                  {member.name} •{" "}
                  <span className="font-normal opacity-70">{member.role}</span>
                  {/* Tooltip Arrow */}
        ...
        <div className="border-t border-gray-900 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-6">
            <a
              href="#"
              className="text-[10px] hover:text-purple-200 transition uppercase tracking-widest"
            >
              Privacy Policy
            </a>
            <a
