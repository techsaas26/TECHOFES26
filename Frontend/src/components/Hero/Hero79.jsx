...
const Hero79 = () => {
  ...
  useGSAP(() => {
    ...
    herotl.from(".numbersn, .hero-subtitle", {
        opacity: 0,
        y: 20,
        duration: 0.8,
        stagger: 0.2
  ...
  return (
    <section ref={container} className='relative min-h-dvh z-10 overflow-hidden'>
      ...
      <div className='absolute bottom-0 left-0 right-0 h-64 bg-linear-to-t from-black/20 via-transparent to-transparent'>
        <svg className='absolute bottom-0 left-0 right-0 w-full h-32 text-black/10' viewBox='0 0 1440 120' preserveAspectRatio='none'>
          <path d='M0,40 Q360,20 720,40 T1440,40 L1440,120 L0,120 Z' fill='currentColor'></path>
        </svg>
      </div>
      ...
      <div className='relative flex flex-col items-center justify-center h-dvh z-20 px-4'>
        ...
        <div className='flex flex-col items-center justify-center gap-2 sm:gap-4 w-full'>
            <div className='flex flex-col sm:flex-row justify-center items-center z-30 hero-container2 gap-0 lg:gap-6'>
                <div className='text-5xl sm:text-7xl lg:text-8xl text-[#eff2ff] hero-title2 leading-none italic font-bold tracking-tight' style={{ fontFamily: 'Geist Sans, sans-serif' }}>
                    TECHOFES
                </div>
            ...
            {/* Subtitle / Divider */}
            <div className="hero-subtitle flex flex-col sm:flex-row items-center justify-center space-x-0 sm:space-x-12 gap-2 sm:gap-0" style={{ marginTop: '-0.5rem' }}>
