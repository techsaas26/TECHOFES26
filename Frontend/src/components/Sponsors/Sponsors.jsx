  ...
  return (
    ...
    <div className="relative min-h-screen bg-white">
      ...
      <div className="fixed inset-0 z-0 bg-black">
        <div className="pointer-events-none absolute -right-24 -top-20 w-96 h-96 rounded-full bg-gradient-to-r from-cyan-400/10 via-purple-400/5 to-pink-400/5 filter blur-3xl opacity-40" style={{clipPath: 'polygon(0 0, 100% 0, 100% 100%, 0 100%)'}} />
        <div className="pointer-events-none absolute -left-24 -bottom-24 w-72 h-72 rounded-full bg-gradient-to-tr from-emerald-300/5 via-teal-400/5 to-indigo-400/5 filter blur-2xl opacity-30" style={{clipPath: 'polygon(0 0, 100% 0, 100% 100%, 0 100%)'}} />
      </div>
